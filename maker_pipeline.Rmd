...
**_$ mv -f x86_64-linux-thread-multi ~ _**  
...
**The command below will edit the altest, altest_gff, model_org, augustus_species, est2genome, protein2genome, and min_contig:**
```{r}
cmd <- with(metadataAssemblies,
