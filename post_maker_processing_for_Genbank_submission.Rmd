...
for(k in 2:nrow(metadataAssemblies)){
    file.rename(from = paste(metadataAssemblies$postMakerGAG_final[k], "genome.tbl", sep = ""),
                to = paste(metadataAssemblies$postMakerGAG_final[k], metadataAssemblies$SppAbbrv[k], ".tbl", sep = ""))
}
for(k in 2:nrow(metadataAssemblies)){
    file.rename(from = paste(metadataAssemblies$postMakerGAG_final[k], "genome.fasta", sep = ""),
                to = paste(metadataAssemblies$postMakerGAG_final[k], metadataAssemblies$SppAbbrv[k], ".fsa", sep = ""))
}
...
for(k in 2:nrow(metadataAssemblies)){
    file.copy(from = paste(metadataAssemblies$postMakerGAG_final[k],  metadataAssemblies$SppAbbrv[k], ".tbl", sep = ""),
...
for(k in 2:nrow(metadataAssemblies)){
    file.copy(from = paste(metadataAssemblies$postMakerGAG_final[k],  metadataAssemblies$SppAbbrv[k], ".fsa", sep = ""),
...
cmd <- with(metadataAssemblies,
            paste("cd ", paste(postMakerGAG_final, "tbl2asn/", sep = ""), " && ",
                  ...
                  " -t ", paste(SppAbbrv, "_template.sbt", sep = ""), 
                  " -p. -M n -Z discrep -a r1k -c bf -V bvg -X E -S T ", sep = ""))
